    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex items-center justify-center bg-neutral-50 px-4">
          <div className="text-center p-8 max-w-md bg-white rounded-2xl shadow-sm border border-neutral-200">
            <div className="flex justify-center items-center mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 32 33" fill="none" aria-hidden>
                <path
            ...
            <div className="flex justify-center items-center mt-6">
              <button
                ...
                className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-lg flex items-center gap-2 transition-colors duration-200 shadow-sm"
              >
