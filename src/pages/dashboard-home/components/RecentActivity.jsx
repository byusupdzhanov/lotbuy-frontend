          ...
          {activities.map((activity) => (
            ...
            >
              <div className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center ${
                activity.type === 'offer_received' ? 'bg-success-50' :
                activity.type === 'message' ? 'bg-primary-50' :
                activity.type === 'lot_created' ? 'bg-success-50' :
                activity.type === 'deal_completed'? 'bg-accent-50' : 'bg-warning-50'
              }`}>
                <Icon 
                  name={activity.icon} 
                  size={18} 
